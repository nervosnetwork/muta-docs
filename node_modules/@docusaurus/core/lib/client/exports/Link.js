...
function Link(_a) {
    ...
    React.createElement("a", Object.assign({}, props, { href: targetLink }))) : (React.createElement(LinkComponent, Object.assign({}, props, { onMouseEnter: onMouseEnter, innerRef: handleRef, to: targetLink })));
}
export default Link;
